...
if __name__ == '__main__':
    ...
    wandb_logger = wandb.init(project="gan_superres", entity=WANDB_ENTITY)
    ...
    #                          batch_size=512, shuffle=True)
    SARDataset = dataset.StuffDataset(train_dir, transforms=transform, inputH=256, inputW=256, scale_factor=2)
    ...
    train_loader = DataLoader(trainFull_set, batch_size=64, shuffle=True)
    valid_loader = DataLoader(test_set, batch_size=64, shuffle=True)
    ...
    train.train_gan(num_epochs=100, generator=generator,
            ...
            aug=None, start_epoch=0, save_every=1, save_name='model_gan2', wandb_logger=wandb_logger,
